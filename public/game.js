(() => {
  ...
  function drawTurret(baseX, baseY, angle, side) {
    ...
    // base
    ctx.fillStyle = side === 'left' ? '#a8dadc' : '#ffd166';
  ...
  function draw() {
    ...
    // Turrets
    drawTurret(leftX + 110,  midY - 10, leftDrawAngle,  'left');
    drawTurret(rightX - 110, midY - 10, rightDrawAngle, 'right');
  }
